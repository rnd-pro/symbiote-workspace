import {
  ...
  PANEL_SETTING_TYPES as PANEL_SETTING_TYPE_VALUES,
  STATE_FIELD_TYPES as STATE_FIELD_TYPE_VALUES,
  STATE_FIELD_PERSISTENCE as STATE_FIELD_PERSISTENCE_VALUES,
  ENGINE_BINDING_SURFACES as ENGINE_BINDING_SURFACE_VALUES,
  ENGINE_NODE_CACHE_MODES as ENGINE_NODE_CACHE_MODE_VALUES,
  VALIDATION_REPORT_STATUSES as VALIDATION_REPORT_STATUS_VALUES,
  VALIDATION_REPORT_SEVERITIES as VALIDATION_REPORT_SEVERITY_VALUES,
  PORTABLE_ID_PATTERN,
...
let PANEL_SETTING_TYPES = new Set(PANEL_SETTING_TYPE_VALUES);
let STATE_FIELD_TYPES = new Set(STATE_FIELD_TYPE_VALUES);
let STATE_FIELD_PERSISTENCE = new Set(STATE_FIELD_PERSISTENCE_VALUES);
let ENGINE_BINDING_SURFACES = new Set(ENGINE_BINDING_SURFACE_VALUES);
let ENGINE_NODE_CACHE_MODES = new Set(ENGINE_NODE_CACHE_MODE_VALUES);
let VALIDATION_REPORT_STATUSES = new Set(VALIDATION_REPORT_STATUS_VALUES);
let VALIDATION_REPORT_SEVERITIES = new Set(VALIDATION_REPORT_SEVERITY_VALUES);
